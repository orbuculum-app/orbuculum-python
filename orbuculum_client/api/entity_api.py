...
class EntityApi:
    ...
    @validate_call
    def get_entity_type_icons(
        self,
        workspace_id: Annotated[StrictInt, Field(description="Workspace ID (required for auth, not used in business logic)")],
        pdf: Annotated[Optional[StrictBool], Field(description="If true, returns smaller PDF-optimized icons (width=8). Defaults to false (regular icons, width=21).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param workspace_id: Workspace ID (required for auth, not used in business logic) (required)
        :type workspace_id: int
        :param pdf: If true, returns smaller PDF-optimized icons (width=8). Defaults to false (regular icons, width=21).
        :type pdf: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_entity_type_icons_serialize(
            workspace_id=workspace_id,
            pdf=pdf,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_entity_type_icons_with_http_info(
        self,
        workspace_id: Annotated[StrictInt, Field(description="Workspace ID (required for auth, not used in business logic)")],
        pdf: Annotated[Optional[StrictBool], Field(description="If true, returns smaller PDF-optimized icons (width=8). Defaults to false (regular icons, width=21).")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EntityTypeIconsResponse]:
        """Get entity type icons
    ...
    @validate_call
    def get_entity_type_icons_without_preload_content(
        self,
        workspace_id: Annotated[StrictInt, Field(description="Workspace ID (required for auth, not used in business logic)")],
        pdf: Annotated[Optional[StrictBool], Field(description="If true, returns smaller PDF-optimized icons (width=8). Defaults to false (regular icons, width=21).")] = None,
        _request_timeout: Union[
    ...
    def _get_entity_type_icons_serialize(
        self,
        workspace_id,
        pdf,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/entity/type-icons',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_entity_types(
        self,
        workspace_id: Annotated[StrictInt, Field(description="Workspace ID (required for auth, not used in business logic — types are global constants)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param workspace_id: Workspace ID (required for auth, not used in business logic — types are global constants) (required)
        :type workspace_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_entity_types_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EntityTypesResponse]:
        """Get entity types catalog
    ...
    def _get_entity_types_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/entity/types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
