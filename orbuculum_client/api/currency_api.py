...
class CurrencyApi:
    ...
    def create_currency(
        ...
        :param create_currency_request: (required)
        :type create_currency_request: CreateCurrencyRequest
    ...
    def create_currency_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateCurrencyResponse]:
        """Create a new currency
    ...
    def _create_currency_serialize(
        ...
        if create_currency_request is not None:
            _body_params = create_currency_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/currency/create',
    ...
    def delete_currency(
        self,
        delete_currency_request: DeleteCurrencyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param delete_currency_request: (required)
        :type delete_currency_request: DeleteCurrencyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def delete_currency_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteCurrencyResponse]:
        """Delete a currency
    ...
    def _delete_currency_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_currency_request is not None:
            _body_params = delete_currency_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/currency/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_currency_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CurrencyGetResponse]:
        """Get a single currency
    ...
    def _get_currency_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/currency/get',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_currencies_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/currency/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_currency(
        self,
        update_currency_request: UpdateCurrencyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_currency_request: (required)
        :type update_currency_request: UpdateCurrencyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def update_currency_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateCurrencyResponse]:
        """Update an existing currency
    ...
    def _update_currency_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_currency_request is not None:
            _body_params = update_currency_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/currency/update',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
