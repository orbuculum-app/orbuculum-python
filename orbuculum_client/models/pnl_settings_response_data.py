...
class PnlSettingsResponseData(BaseModel):
    """
    Saved settings
    """ # noqa: E501
    settings: Optional[PnlSettingsResponseDataSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": PnlSettingsResponseDataSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
