...
class ListMembers200ResponseData(BaseModel):
    """
    ListMembers200ResponseData
    """ # noqa: E501
    members: Optional[List[ListMembers200ResponseDataMembersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [ListMembers200ResponseDataMembersInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
