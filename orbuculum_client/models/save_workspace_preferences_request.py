...
class SaveWorkspacePreferencesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["workspace_id", "type", "settings"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pnl', 'balance', 'cashflow']):
            raise ValueError("must be one of enum values ('pnl', 'balance', 'cashflow')")
        return value
