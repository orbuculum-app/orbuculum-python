...
class MassDuplicateTransactionsRequest(BaseModel):
    """
    MassDuplicateTransactionsRequest
    """ # noqa: E501
    workspace_id: StrictInt = Field(description="Workspace ID")
    transaction_ids: List[StrictInt] = Field(description="Array of transaction IDs to duplicate (max 500)")
    __properties: ClassVar[List[str]] = ["workspace_id", "transaction_ids"]
