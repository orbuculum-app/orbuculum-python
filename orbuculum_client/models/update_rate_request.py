...
class UpdateRateRequest(BaseModel):
    ...
    id: StrictInt = Field(description="Rate record ID")
    rate: StrictStr = Field(description="New display rate value")
    dt: Optional[StrictStr] = Field(default=None, description="New datetime (optional)")
    __properties: ClassVar[List[str]] = ["workspace_id", "id", "rate", "dt"]
