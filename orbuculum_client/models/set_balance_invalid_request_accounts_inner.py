...
class SetBalanceInvalidRequestAccountsInner(BaseModel):
    """
    SetBalanceInvalidRequestAccountsInner
    """ # noqa: E501
    account_id: StrictInt = Field(description="Account ID")
    var_date: Optional[StrictStr] = Field(default=None, description="Recalculate from this date (ISO timestamp, null for all)", alias="date")
    __properties: ClassVar[List[str]] = ["account_id", "date"]
