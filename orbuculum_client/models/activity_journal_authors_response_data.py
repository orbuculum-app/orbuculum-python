...
class ActivityJournalAuthorsResponseData(BaseModel):
    """
    ActivityJournalAuthorsResponseData
    """ # noqa: E501
    authors: Optional[List[ActivityJournalAuthorsResponseDataAuthorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authors": [ActivityJournalAuthorsResponseDataAuthorsInner.from_dict(_item) for _item in obj["authors"]] if obj.get("authors") is not None else None
        })
        return _obj
