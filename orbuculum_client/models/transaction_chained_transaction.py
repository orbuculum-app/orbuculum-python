...
class TransactionChainedTransaction(BaseModel):
    """
    ...
    sender_amount: Optional[StrictStr] = Field(default=None, description="Decimal value as string to preserve precision.")
    receiver_amount: Optional[StrictStr] = Field(default=None, description="Decimal value as string to preserve precision.")
    __properties: ClassVar[List[str]] = ["id", "sender_account_id", "receiver_account_id", "sender_amount", "receiver_amount"]
