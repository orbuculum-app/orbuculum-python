...
class InviteMember201Response(BaseModel):
    """
    InviteMember201Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[InviteMember201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": InviteMember201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
