...
class GetTagAccounts200Response(BaseModel):
    """
    GetTagAccounts200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[GetTagAccounts200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetTagAccounts200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
