...
class ToggleFullAccessRequest(BaseModel):
    """
    ...
    value: StrictBool = Field(description="true = grant full access, false = revoke")
    __properties: ClassVar[List[str]] = ["workspace_id", "user_id", "value"]
