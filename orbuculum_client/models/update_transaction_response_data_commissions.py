...
class UpdateTransactionResponseDataCommissions(BaseModel):
    """
    Per-slot commission CRUD result (sender + receiver)
    """ # noqa: E501
    sender: Optional[UpdateCommissionResult] = None
    receiver: Optional[UpdateCommissionResult] = None
    __properties: ClassVar[List[str]] = ["sender", "receiver"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sender": UpdateCommissionResult.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            "receiver": UpdateCommissionResult.from_dict(obj["receiver"]) if obj.get("receiver") is not None else None
        })
        return _obj
