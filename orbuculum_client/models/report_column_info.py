...
class ReportColumnInfo(BaseModel):
    ...
    """ # noqa: E501
    attribute: StrictStr = Field(description="Shared sub-schema: column descriptor for Balances report GridView")
    format: StrictStr
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attribute", "format", "label"]
