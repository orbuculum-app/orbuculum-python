...
class GetRateResponseData(BaseModel):
    ...
    rate: Optional[StrictStr] = Field(default=None, description="Exchange rate value (numeric string, 18 decimal places)")
    dt: Optional[StrictStr] = Field(default=None, description="Timestamp of the rate record found")
    __properties: ClassVar[List[str]] = ["currency_id", "rate", "dt"]
