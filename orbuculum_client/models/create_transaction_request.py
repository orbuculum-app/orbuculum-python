...
class CreateTransactionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workspace_id", "sender_account_id", "receiver_account_id", "sender_amount", "receiver_amount", "dt", "project_id", "comment", "description", "done", "commission_applied", "apikey", "sender_commission", "receiver_commission", "doubler_account_id", "doubler_amount", "commission_appliance", "timezone", "account_id", "leg1_sender_commission", "leg1_receiver_commission", "leg2_sender_commission", "leg2_receiver_commission"]
