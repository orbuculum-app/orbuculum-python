...
class ListFilesData(BaseModel):
    ...
    ListFilesData
    """ # noqa: E501
    files: List[TransactionFile] = Field(description="Array of file metadata for the transaction")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [TransactionFile.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
