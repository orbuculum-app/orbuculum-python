...
class RateListResponseDataRatesValueInner(BaseModel):
    """
    RateListResponseDataRatesValueInner
    """ # noqa: E501
    dt: Optional[StrictStr] = Field(default=None, description="Rate timestamp")
    rate: Optional[StrictStr] = Field(default=None, description="Exchange rate value")
    __properties: ClassVar[List[str]] = ["dt", "rate"]
