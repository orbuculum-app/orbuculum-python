...
class UpdateAccountRequest(BaseModel):
    ...
    initial_balance: Optional[StrictStr] = Field(default=None, description="Account initial balance amount (positive or negative numeric string). Accepts '', '0', '0.00' to delete an existing initial balance transaction. Omit / null to leave initial balance unchanged.")
    __properties: ClassVar[List[str]] = ["workspace_id", "id", "name", "currency_id", "entity_id", "hidden", "hide_balances", "commission_enabled", "commission_appliance", "commission_sender_account", "commission_receiver_account", "limited", "api_id", "type", "tags", "initial_balance"]
