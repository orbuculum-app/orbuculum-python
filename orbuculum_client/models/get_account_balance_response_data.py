...
class GetAccountBalanceResponseData(BaseModel):
    """
    GetAccountBalanceResponseData
    """ # noqa: E501
    balance: Optional[StrictStr] = Field(default=None, description="Account balance at the specified date. Null if balance is hidden for this role.")
    currency: Optional[StrictStr] = Field(default=None, description="Currency name")
    currency_id: Optional[StrictInt] = Field(default=None, description="Currency ID")
    precision: Optional[StrictInt] = Field(default=None, description="Currency decimal precision")
    __properties: ClassVar[List[str]] = ["balance", "currency", "currency_id", "precision"]
