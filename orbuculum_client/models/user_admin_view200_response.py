...
class UserAdminView200Response(BaseModel):
    """
    UserAdminView200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[UserAdminView200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": UserAdminView200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
