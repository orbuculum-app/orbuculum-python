...
class CashflowSettingsRequest(BaseModel):
    """
    Request body for POST /api/reports/save-cashflow-settings
    """ # noqa: E501
    settings: CashflowSettingsRequestSettings
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": CashflowSettingsRequestSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
