...
class UpdateMemberRoleRequest(BaseModel):
    ...
    user_id: StrictInt = Field(description="User ID whose role to update")
    role_id: StrictInt = Field(description="New role ID to assign")
    __properties: ClassVar[List[str]] = ["workspace_id", "user_id", "role_id"]
