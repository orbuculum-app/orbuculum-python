...
class InviteMember201ResponseData(BaseModel):
    """
    InviteMember201ResponseData
    """ # noqa: E501
    member: Optional[InviteMember201ResponseDataMember] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "member": InviteMember201ResponseDataMember.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
        return _obj
