...
class GetRoles200ResponseData(BaseModel):
    """
    GetRoles200ResponseData
    """ # noqa: E501
    roles: Optional[List[GetRoles200ResponseDataRolesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [GetRoles200ResponseDataRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
