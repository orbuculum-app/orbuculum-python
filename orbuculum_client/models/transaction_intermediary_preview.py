...
class TransactionIntermediaryPreview(BaseModel):
    """
    Dry-run preview response for intermediary transaction create. Both legs computed; no DB writes performed.
    """ # noqa: E501
    status: StrictInt = Field(description="HTTP status code (always 200 for preview).")
    data: TransactionIntermediaryPreviewData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TransactionIntermediaryPreviewData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
