...
class UpdateLabelTabRequest(BaseModel):
    """
    ...
    label_id: StrictInt = Field(description="Label ID to configure")
    accounts: Dict[str, StrictInt] = Field(description="Map account_id → access_level (1=none, 2=read, 3=manage)")
    __properties: ClassVar[List[str]] = ["workspace_id", "user_id", "label_id", "accounts"]
