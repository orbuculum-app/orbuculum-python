...
class CurrencyListResponseDataImportersInner(BaseModel):
    """
    CurrencyListResponseDataImportersInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Importer ID")
    name: Optional[StrictStr] = Field(default=None, description="Importer name")
