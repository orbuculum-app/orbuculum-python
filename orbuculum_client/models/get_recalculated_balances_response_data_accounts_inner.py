...
class GetRecalculatedBalancesResponseDataAccountsInner(BaseModel):
    """
    GetRecalculatedBalancesResponseDataAccountsInner
    """ # noqa: E501
    account_id: StrictInt
    is_calculating: StrictBool
    __properties: ClassVar[List[str]] = ["account_id", "is_calculating"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_calculating": obj.get("is_calculating")
        })
        return _obj
