...
class UpdateUsername200ResponseData(BaseModel):
    """
    ...
    has_local_auth: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "username", "email", "photo_url", "has_local_auth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "has_local_auth": obj.get("has_local_auth")
        })
        return _obj
