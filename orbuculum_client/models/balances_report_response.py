...
class BalancesReportResponse(BaseModel):
    """
    Response containing Balances report data
    """ # noqa: E501
    status: StrictInt = Field(description="Response schema for GET /api/reports/get-balances")
    data: BalancesReportResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BalancesReportResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
