...
class EntityTypesResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictInt = Field(description="Response schema for GET /api/entity/types  Returns the catalog of entity types (id + localized name) as an array of objects. Includes TYPE_PoL with id=null per OMM-1948 — null is a valid, semantically meaningful value (P&L source category).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": EntityTypesResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
