...
class UserAdminIndex200ResponseData(BaseModel):
    """
    UserAdminIndex200ResponseData
    """ # noqa: E501
    users: Optional[List[UserAdminIndex200ResponseDataUsersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserAdminIndex200ResponseDataUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
