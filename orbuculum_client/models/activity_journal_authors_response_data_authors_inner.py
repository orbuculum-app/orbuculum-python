...
class ActivityJournalAuthorsResponseDataAuthorsInner(BaseModel):
    """
    ActivityJournalAuthorsResponseDataAuthorsInner
    """ # noqa: E501
    user_id: Optional[StrictInt] = Field(default=None, description="User ID")
    user_name: Optional[StrictStr] = Field(default=None, description="User display name")
    user_email: Optional[StrictStr] = Field(default=None, description="User email address")
    __properties: ClassVar[List[str]] = ["user_id", "user_name", "user_email"]
