...
class GetSelectionTree200Response(BaseModel):
    """
    GetSelectionTree200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[GetSelectionTree200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetSelectionTree200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
