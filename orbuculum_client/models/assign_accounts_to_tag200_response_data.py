...
class AssignAccountsToTag200ResponseData(BaseModel):
    """
    AssignAccountsToTag200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    assigned_count: Optional[StrictInt] = None
    already_assigned_count: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "assigned_count", "already_assigned_count", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "already_assigned_count": obj.get("already_assigned_count"),
