...
class TransactionFile(BaseModel):
    ...
    transaction_id: Optional[StrictInt] = Field(default=None, description="Parent transaction ID")
    original_name: Optional[StrictStr] = Field(default=None, description="Original file name")
    mime_type: Optional[StrictStr] = Field(default=None, description="File MIME type")
    __properties: ClassVar[List[str]] = ["id", "transaction_id", "original_name", "mime_type"]
