...
class GetRateHistory200ResponseData(BaseModel):
    """
    GetRateHistory200ResponseData
    """ # noqa: E501
    rates: Optional[List[GetRateHistory200ResponseDataRatesInner]] = None
    currency: Optional[GetRateHistory200ResponseDataCurrency] = None
    __properties: ClassVar[List[str]] = ["rates", "currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rates": [GetRateHistory200ResponseDataRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
            "currency": GetRateHistory200ResponseDataCurrency.from_dict(obj["currency"]) if obj.get("currency") is not None else None
        })
        return _obj
