...
class UpdateTransactionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workspace_id", "id", "sender_account_id", "receiver_account_id", "sender_amount", "receiver_amount", "dt", "project_id", "comment", "description", "done", "commission_applied", "account_id"]
