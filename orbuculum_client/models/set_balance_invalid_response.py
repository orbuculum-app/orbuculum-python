...
class SetBalanceInvalidResponse(BaseModel):
    """
    Response after successful balance recalculation
    """ # noqa: E501
    status: StrictInt
    data: SetBalanceInvalidResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SetBalanceInvalidResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
