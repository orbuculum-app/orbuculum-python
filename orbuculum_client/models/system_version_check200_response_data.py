...
class SystemVersionCheck200ResponseData(BaseModel):
    """
    SystemVersionCheck200ResponseData
    """ # noqa: E501
    up_to_date: Optional[StrictBool] = None
    status: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["up_to_date", "status"]
