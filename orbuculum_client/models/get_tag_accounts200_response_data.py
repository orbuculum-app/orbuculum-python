...
class GetTagAccounts200ResponseData(BaseModel):
    """
    GetTagAccounts200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    accounts: Optional[List[GetTagAccounts200ResponseDataAccountsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "accounts": [GetTagAccounts200ResponseDataAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
