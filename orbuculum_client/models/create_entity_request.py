...
class CreateEntityRequest(BaseModel):
    ...
    type: Optional[StrictInt] = Field(default=None, description="Entity type. Allowed: null, 1 (DEBT), 2 (ACC, default), 3 (IGNORE), 5 (CFONLY_ACCOUNT), 8 (CFONLY_SOURCE), 9 (REVENUE), 10 (COSTS).")
