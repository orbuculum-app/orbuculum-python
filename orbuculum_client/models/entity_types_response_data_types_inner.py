...
class EntityTypesResponseDataTypesInner(BaseModel):
    """
    EntityTypesResponseDataTypesInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Entity type ID. Matches Entity::TYPE_* constants. TYPE_PoL has id=null.")
    name: StrictStr = Field(description="Localized human-readable type name.")
