...
class BulkAssignPermissionsRequestPermissionsAccountGroupsInner(BaseModel):
    """
    BulkAssignPermissionsRequestPermissionsAccountGroupsInner
    """ # noqa: E501
    account_group_id: Optional[StrictInt] = None
    can_manage: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["account_group_id", "can_manage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account_group_id": obj.get("account_group_id"),
