...
class EntityTypesResponseData(BaseModel):
    """
    EntityTypesResponseData
    """ # noqa: E501
    types: List[EntityTypesResponseDataTypesInner] = Field(description="Catalog of entity types in definition order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "types": [EntityTypesResponseDataTypesInner.from_dict(_item) for _item in obj["types"]] if obj.get("types") is not None else None
        })
        return _obj
