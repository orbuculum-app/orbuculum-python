...
class CreateAccountRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Account name (optional, defaults to empty string when omitted; OMM-1868)")
    ...
    __properties: ClassVar[List[str]] = ["workspace_id", "entity_id", "name", "currency_id", "hidden", "hide_balances", "commission_enabled", "commission_appliance", "commission_sender_account", "commission_receiver_account", "limited", "api_id", "type", "initial_balance"]
