...
class SearchAccounts200ResponseData(BaseModel):
    """
    SearchAccounts200ResponseData
    """ # noqa: E501
    items: Optional[List[SearchAccounts200ResponseDataItemsInner]] = Field(default=None, description="List of matching accounts")
    total: Optional[StrictInt] = Field(default=None, description="Number of returned items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SearchAccounts200ResponseDataItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
