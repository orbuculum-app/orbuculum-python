...
class MassSetDoneRequest(BaseModel):
    """
    MassSetDoneRequest
    """ # noqa: E501
    ...
    done: StrictBool = Field(description="true = set done, false = set undone")
    __properties: ClassVar[List[str]] = ["workspace_id", "transaction_ids", "done"]
