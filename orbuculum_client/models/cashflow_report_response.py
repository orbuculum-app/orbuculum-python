...
class CashflowReportResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictInt = Field(description="Response schema for GET /api/reports/get-cashflow")
    data: CashflowReportResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CashflowReportResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
