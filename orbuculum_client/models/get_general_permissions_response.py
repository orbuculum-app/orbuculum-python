...
class GetGeneralPermissionsResponse(BaseModel):
    """
    Response wrapper for GET /api/permission/general
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[GetGeneralPermissionsResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetGeneralPermissionsResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
