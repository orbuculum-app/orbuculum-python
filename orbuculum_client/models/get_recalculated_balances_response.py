...
class GetRecalculatedBalancesResponse(BaseModel):
    """
    Balance recalculation status per account
    """ # noqa: E501
    status: StrictInt
    data: GetRecalculatedBalancesResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetRecalculatedBalancesResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
