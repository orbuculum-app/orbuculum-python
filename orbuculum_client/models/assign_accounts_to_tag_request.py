...
class AssignAccountsToTagRequest(BaseModel):
    """
    AssignAccountsToTagRequest
    """ # noqa: E501
    workspace_id: StrictInt = Field(description="Workspace ID")
    id: StrictInt = Field(description="Tag ID")
    account_ids: List[StrictInt] = Field(description="Account IDs to assign (max 50)")
    __properties: ClassVar[List[str]] = ["workspace_id", "id", "account_ids"]
