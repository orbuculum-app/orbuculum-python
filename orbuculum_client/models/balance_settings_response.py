...
class BalanceSettingsResponse(BaseModel):
    """
    Response for POST /api/reports/save-balance-settings
    """ # noqa: E501
    status: StrictInt
    data: BalanceSettingsResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BalanceSettingsResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
