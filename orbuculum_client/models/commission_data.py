...
class CommissionData(BaseModel):
    ...
    """ # noqa: E501
    sender_amount: StrictStr = Field(description="Commission sender amount. Decimal value serialized as string to preserve precision (typically 2 decimal places); avoids JSON float rounding.")
    receiver_amount: StrictStr = Field(description="Commission receiver amount. Decimal value serialized as string to preserve precision (typically 2 decimal places); avoids JSON float rounding.")
