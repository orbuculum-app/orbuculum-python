...
class ReportLabelItemWithIcon(BaseModel):
    """
    Label item with icon HTML (used in Cashflow report)
    """ # noqa: E501
    id: StrictInt = Field(description="Shared sub-schema: label item with icon HTML (used in Cashflow report)")
    name: StrictStr
    icon_html: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "icon_html"]
