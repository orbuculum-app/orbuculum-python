...
class RemoveAccountFromTagRequest(BaseModel):
    """
    RemoveAccountFromTagRequest
    """ # noqa: E501
    workspace_id: StrictInt = Field(description="Workspace ID")
    id: StrictInt = Field(description="Tag ID")
    account_id: StrictInt = Field(description="Account ID to remove")
    __properties: ClassVar[List[str]] = ["workspace_id", "id", "account_id"]
