...
class GetRecalculatedBalancesResponseData(BaseModel):
    """
    GetRecalculatedBalancesResponseData
    """ # noqa: E501
    accounts: List[GetRecalculatedBalancesResponseDataAccountsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [GetRecalculatedBalancesResponseDataAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
