...
class UpdateRoleRequest(BaseModel):
    ...
    role_id: StrictInt = Field(description="Role ID to update")
    role_name: StrictStr = Field(description="New role name")
    __properties: ClassVar[List[str]] = ["workspace_id", "role_id", "role_name"]
