...
class IntermediaryTransactionUpdatedResponse(BaseModel):
    """
    ...
    data: IntermediaryTransactionUpdatedData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": IntermediaryTransactionUpdatedData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
