...
class UpdateAccountTabRequestAccountsValue(BaseModel):
    """
    UpdateAccountTabRequestAccountsValue
    """ # noqa: E501
    has_access: Optional[StrictBool] = None
    full_access: Optional[StrictBool] = None
    show_balance: Optional[StrictBool] = None
    hide_transactions: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["has_access", "full_access", "show_balance", "hide_transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hide_transactions": obj.get("hide_transactions")
        })
        return _obj
