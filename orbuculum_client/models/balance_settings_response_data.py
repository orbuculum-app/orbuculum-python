...
class BalanceSettingsResponseData(BaseModel):
    """
    Saved settings
    """ # noqa: E501
    settings: Optional[BalanceSettingsResponseDataSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": BalanceSettingsResponseDataSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
