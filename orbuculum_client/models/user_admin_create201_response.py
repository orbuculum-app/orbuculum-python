...
class UserAdminCreate201Response(BaseModel):
    """
    UserAdminCreate201Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[UserAdminCreate201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": UserAdminCreate201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
