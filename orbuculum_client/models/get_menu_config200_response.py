...
class GetMenuConfig200Response(BaseModel):
    """
    GetMenuConfig200Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[Dict[str, Any]] = Field(default=None, description="Category/entity/account tree with balances, permissions, and sorting preferences")
