...
class SetBalanceInvalidRequest(BaseModel):
    """
    Request body for triggering balance recalculation
    """ # noqa: E501
    workspace_id: StrictInt = Field(description="Workspace ID")
    accounts: List[SetBalanceInvalidRequestAccountsInner] = Field(description="Array of accounts to recalculate (max 100)")
    __properties: ClassVar[List[str]] = ["workspace_id", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accounts": [SetBalanceInvalidRequestAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
