...
class CreateConnectionSource201Response(BaseModel):
    """
    CreateConnectionSource201Response
    """ # noqa: E501
    status: Optional[StrictInt] = None
    data: Optional[CreateConnectionSource201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateConnectionSource201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
