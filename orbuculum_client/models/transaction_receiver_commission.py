...
class TransactionReceiverCommission(BaseModel):
    """
    ...
    amount: Optional[StrictStr] = Field(default=None, description="Commission amount. Decimal value as string to preserve precision.")
    account_id: Optional[StrictInt] = None
    account_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "amount", "account_id", "account_name"]
