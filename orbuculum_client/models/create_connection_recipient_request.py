...
class CreateConnectionRecipientRequest(BaseModel):
    """
    CreateConnectionRecipientRequest
    """ # noqa: E501
    workspace_id: StrictInt = Field(description="Workspace ID")
    identifier: StrictStr = Field(description="Connection identifier (id_key) from source")
    sender_id: StrictInt = Field(description="Sender account ID in recipient workspace")
    receiver_id: StrictInt = Field(description="Receiver account ID in recipient workspace")
    icon_id: Optional[StrictInt] = Field(default=None, description="Optional icon ID for the connection")
    __properties: ClassVar[List[str]] = ["workspace_id", "identifier", "sender_id", "receiver_id", "icon_id"]
