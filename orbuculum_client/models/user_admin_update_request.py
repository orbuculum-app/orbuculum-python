...
class UserAdminUpdateRequest(BaseModel):
    ...
    password: Optional[StrictStr] = Field(default=None, description="New password (optional)")
    status: Optional[StrictInt] = Field(default=None, description="User status (0 = disabled, 10 = active)")
    project_ids: Optional[List[StrictInt]] = Field(default=None, description="Array of project IDs to assign")
    __properties: ClassVar[List[str]] = ["id", "username", "email", "password", "status", "project_ids"]
