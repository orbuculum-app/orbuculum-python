...
class MassSetDateRequest(BaseModel):
    """
    MassSetDateRequest
    """ # noqa: E501
    ...
    var_date: StrictStr = Field(description="New date in Y-m-d H:i:s format", alias="date")
    __properties: ClassVar[List[str]] = ["workspace_id", "transaction_ids", "date"]
