...
class DeleteFileRequest(BaseModel):
    ...
    transaction_id: StrictInt = Field(description="Parent transaction ID")
    file_id: StrictInt = Field(description="File ID to delete")
    __properties: ClassVar[List[str]] = ["workspace_id", "transaction_id", "file_id"]
