...
class UserAdminSaveOwnershipRequestOwnershipInner(BaseModel):
    """
    UserAdminSaveOwnershipRequestOwnershipInner
    """ # noqa: E501
    project_id: StrictInt = Field(description="Project/workspace ID")
    is_owner: StrictBool = Field(description="Whether user is owner of this workspace")
    __properties: ClassVar[List[str]] = ["project_id", "is_owner"]
